...
class XluaGlideModule : AppGlideModule(),JsExtensionClass{
    ...
    override fun registerComponents(context: Context, glide: Glide, registry: Registry) {
        ...
        builder.addInterceptor { chain: Interceptor.Chain ->
            ...
            val bitmap =
                BitmapFactory.decodeByteArray(bt, 0, bt.size,options) ?: return@addInterceptor response
            ...
            val body: ResponseBody = try {
                ...
                DiskCache.SCRIPT_ENGINE.eval(AutoBase64.decodeToString(js), simpleBindings)
